...
| OS      | Arch  |  Format    | Link                                                                                         |
|:--------|:-----:|:----------:|:---------------------------------------------------------------------------------------------|
| Linux   |  x64  | AppImage   | [Download](https://nightly.link/krakjoe/em/workflows/em/develop/em-linux-x64-AppImage.zip)   |
| Linux   | arm64 | AppImage   | [Download](https://nightly.link/krakjoe/em/workflows/em/develop/em-linux-arm64-AppImage.zip) |
| Linux   |  x64  | zip        | [Download](https://nightly.link/krakjoe/em/workflows/em/develop/em-linux-x64-zip.zip)        |
| Linux   | arm64 | zip        | [Download](https://nightly.link/krakjoe/em/workflows/em/develop/em-linux-arm64-zip.zip)      |
| MacOS   |  x64  | dmg        | [Download](https://nightly.link/krakjoe/em/workflows/em/develop/em-macos-x64-dmg.zip)        |
| MacOS   | arm64 | dmg        | [Download](https://nightly.link/krakjoe/em/workflows/em/develop/em-macos-arm64-dmg.zip)      |
| MacOS   |  x64  | zip        | [Download](https://nightly.link/krakjoe/em/workflows/em/develop/em-macos-x64-zip.zip)        |
| MacOS   | arm64 | zip        | [Download](https://nightly.link/krakjoe/em/workflows/em/develop/em-macos-arm64-zip.zip)      |
| Windows |  x64  | portable   | [Download](https://nightly.link/krakjoe/em/workflows/em/develop/em-windows-x64-exe.zip)      |
| Windows |  x64  | setup      | [Download](https://nightly.link/krakjoe/em/workflows/em/develop/em-windows-x64-nsis.zip)     |
| Windows |  x64  | zip        | [Download](https://nightly.link/krakjoe/em/workflows/em/develop/em-windows-x64-zip.zip)      |
